...
const FeaturedProducts = ({ featuredProducts }) => {
    ...
    const nextSlide = () => {
        setCurrentIndex((prevState) => {
            let nextIndex = prevState + itemsPerPage;
            if (nextIndex > featuredProducts.length - itemsPerPage) {
                nextIndex = nextIndex - itemsPerPage + 1;
            }
            return nextIndex;
        });
    };
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="relative">
                    ...
                    <button
                        ...
                        className={`absolute top-1/2 -left-4 -translate-y-1/2 p-2 rounded-full transition-colors duration-300 ${
                            isStartDisabled
                    ...
                    <button
                        ...
                        className={`absolute top-1/2 -right-4 -translate-y-1/2 p-2 rounded-full transition-colors duration-300 ${
                            isEndDisabled
                                ? "bg-gray-400 cursor-not-allowed"
                                : "bg-emerald-600 hover:bg-emerald-500"
                        }`}
